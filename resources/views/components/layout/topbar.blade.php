                        ...
                        <li class="flex-three">
                            <div class="icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.5 5.62525V12.5003M12.5 7.50025V14.3753M12.9192 17.2903L16.9817 15.2594C17.2992 15.1011 17.5 14.7761 17.5 14.4211V4.01692C17.5 3.32025 16.7667 2.86692 16.1433 3.17859L12.9192 4.79025C12.655 4.92275 12.3442 4.92275 12.0808 4.79025L7.91917 2.71025C7.78901 2.6452 7.64551 2.61133 7.5 2.61133C7.35449 2.61133 7.21098 2.6452 7.08083 2.71025L3.01833 4.74109C2.7 4.90025 2.5 5.22525 2.5 5.57942V15.9836C2.5 16.6803 3.23333 17.1336 3.85667 16.8219L7.08083 15.2103C7.345 15.0778 7.65583 15.0778 7.91917 15.2103L12.0808 17.2911C12.345 17.4228 12.6558 17.4228 12.9192 17.2911V17.2903Z" stroke="CurrentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
                            <p class="text-color-1">Nairobi, Kenya</p>
                        </li>
                        <li class="flex-three">
                            <div class="icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="text-color-1">Mon – Sat 8:00 – 18:00</p>
                        </li>
                        <li class="flex-three">
                            <div class="icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="text-color-1"><a href="tel:+254700000000">+254 700 000 000</a></p>
                        </li>
                    </ul>
                </div>
                <div class="tf-top-bar-right flex-three">
                    <p class="text-color-1">Follow us:</p>
                    <ul class="flex-three">
                        <li><a href="#" aria-label="Facebook"><i class="icon-autodeal-facebook"></i></a></li>
                        <li><a href="#" aria-label="Instagram"><i class="icon-autodeal-instagram"></i></a></li>
                        <li><a href="#" aria-label="Twitter"><i class="icon-autodeal-twitter"></i></a></li>
                        <li><a href="#" aria-label="YouTube"><i class="icon-autodeal-youtube"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
